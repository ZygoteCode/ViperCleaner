...
public class Optimizer
{
    ...
    private bool optimizeCompleted;

    public Optimizer(string name, string category = "Windows", string status = "Ready")
    {
        this.name = name;
    ...
    public bool IsOptimizingCompleted()
    {
        return this.optimizeCompleted;
    }

    public void SetOptimizingCompleted(bool optimizeCompleted)
    {
        this.optimizeCompleted = optimizeCompleted;
    }
}